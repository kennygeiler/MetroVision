...
src/db/boundary-tuning-queries.ts     -- Presets, human verified cuts revisions, eval runs, film preset assignment
...
eval/gold/template.json               -- Human verified cuts eval file shape (boundaries + optional shots/slots)
scripts/eval-pipeline.ts              -- Boundary (F1) + optional slot accuracy vs human verified cuts JSON
