...
- [ ] **REQ-BT-02** — **Human verified cuts revision history**, **boundary eval run** persistence + scoring API, worker **detect job** applying preset without relying on global env alone. *(Phase 10, 10-01)*
